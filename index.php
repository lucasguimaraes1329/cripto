...
<body>
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>BTC</td>
              <td>$72,000.00</td>
              <td class="positivo">+2.13%</td>
              <td class="positivo">+8.37%</td>
            </tr>
            <tr>
              <td>ETH</td>
              <td>$3,600.00</td>
              <td class="negativo">-1.23%</td>
              <td class="positivo">+3.23%</td>
            </tr>
            <tr>
              <td>SOL</td>
              <td>$220.00</td>
              <td class="negativo">-9.95%</td>
              <td class="positivo">+1.58%</td>
            </tr>
            <tr>
              <td>DOGE</td>
              <td>$0.18</td>
              <td class="positivo">+2.05%</td>
              <td class="positivo">+2.98%</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <!-- Mapa Global -->
  <section class="mapa">
    <h2>🌍 Adoção Global de Criptomoedas</h2>
    <p>Veja como o uso de criptomoedas cresce pelo mundo.</p>
    <div class="mapa-container">
      <iframe src="https://blocks.wizb.it/" 
              width="100%" 
              height="500" 
              style="border:none; border-radius:8px;" 
              title="Mapa de adoção global de criptomoedas"
